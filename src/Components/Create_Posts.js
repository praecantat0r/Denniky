        ...
        <div>
            <div className="bg-[url('/Assets/main-small-bg.png')] flex h-screen items-center justify-center bg-cover overflow-hidden 2xl:bg-[url('/Assets/background.png')] md:bg-[url('/Assets/md-screen-bg.png')]">
                ...
                <form action="" className="h-full w-full flex flex-col p-10 rounded-md">
                    <label >
                        <p className="w-full flex justify-center items-center text-gray-600 font-bold">Meno</p>
                    ...
                    <label className="mt-8">
                        <p className="w-full flex justify-center items-center text-gray-600 font-bold">Popis</p>
                    ...
                    <label className="">
                        <p className="w-full flex justify-center items-center text-gray-600 font-bold">Ikona</p>
                        ...
                        <button type="submit" className="text-gray-600 m-2 bg-pink-violet-200 mt-10 rounded-md font-bold" onClick={HandleSubmitt}>Odoslat</button>
